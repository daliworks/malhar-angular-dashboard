...
describe('Directive: dashboard', function () {
  ...
  beforeEach(inject(function (_$compile_, $rootScope, _DashboardState_, _$q_) {
    ...
    // element setup
    element = $compile('<div dashboard options="dashboardOptions"></div>')(scope);
    scope.$digest();
  ...
  it('should be able to use a different dashboard template', inject(function($compile, $templateCache) {
    ...
    var customElement = $compile('<div dashboard options="dashboardOptions" template-url="myCustomTemplate.html"></div>')(scope);
    scope.$digest();
  ...
  it('should set scope.widgets to an empty array if no defaultWidgets are specified', inject(function($compile) {
    ...
    var element2 = $compile('<div dashboard options="dashboardOptions"></div>')(scope);
    scope.$digest();
  ...
  it('should not call saveDashboard on load', inject(function($compile) {
    ...
    var s = scope.$new();
    element = $compile('<div dashboard options="dashboardOptions"></div>')(s);
    scope.$digest();
